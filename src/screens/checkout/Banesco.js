...
const Banesco = () => {
  ...
  const [referenciaBanescoFocused, setReferenciaBanescoFocused] = useState(false);
  ...
  const sendingDates = async (referenciaBanesco, image) => {
    // Validaciones
    if (!referenciaBanesco) {
    ...
    try {
      ...
      const banescoObj = {
        ...
        referenciabanesco: referenciaBanesco,
      ...
      // console.log(pedido.restauranteId);
      // console.log(pedidoCompletado.id);
      await firebase.db
  ...
  const referenciaBanescoFocus = () => {
    setReferenciaBanescoFocused(true);
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAwareScrollView enableOnAndroid>
        <View style={{ alignItems: 'center' }}>
          ...
          <Text style={{ fontWeight: 'bold', color: 'red' }}>Solo de Banesco a Banesco</Text>
          <Text style={{ fontWeight: 'bold' }}>0134 0031 8603 1321 0413</Text>
          <Text style={{ fontWeight: 'bold' }}>Corporación Garani, C.A.</Text>
          <Text style={{ fontWeight: 'bold' }}>Rif. J-30656629-5</Text>
        </View>
        <View style={styles.editForm}>
          ...
          <UnderlineTextInput
            ...
            onChangeText={(referenciaBanesco) => setReferenciaBanesco(referenciaBanesco)}
            onFocus={referenciaBanescoFocus}
            inputFocused={referenciaBanescoFocused}
          ...
          <View style={{ paddingHorizontal: 60, paddingVertical: 15 }}>
            <Button
              onPress={() => {
                sendingDates(referenciaBanesco, image);
              }}

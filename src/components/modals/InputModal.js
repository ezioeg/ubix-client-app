...
type Props = {
  ...
  inputKeyboardType: 'default' | 'number-pad' | 'numeric' | 'email-address' | 'phone-pad',
  buttonTitle: string,
  onButtonPress: () => {},
  onClosePress: () => {},
          ...
          <KeyboardAvoidingView behavior="position" enabled={IOS}>
            <View style={styles.modalContainer}>
              ...
              <View style={styles.buttonContainer}>
                <Button onPress={onButtonPress} title={buttonTitle} buttonStyle={styles.button} />
              </View>

              <LinkButton onPress={onClosePress} title={'Close'.toUpperCase()} />
            </View>
          </KeyboardAvoidingView>
        </TouchableWithoutFeedback>
      </View>

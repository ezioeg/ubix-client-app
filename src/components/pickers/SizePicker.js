...
// SizePicker
const SizePicker = ({ activeOpacity, color, onPress, picked, title, titleStyle }: Props) => (
  <View
    style={[
      styles.container,
  ...
  >
    <TouchableItem onPress={onPress} activeOpacity={activeOpacity || 0.85} style={styles.picker}>
      <View style={styles.picker}>
        <Text style={[styles.title, titleStyle, picked && { color: PICKED_TEXT_COLOR }]}>
